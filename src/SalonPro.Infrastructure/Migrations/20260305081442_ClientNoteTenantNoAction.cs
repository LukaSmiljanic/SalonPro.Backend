...
{
    /// <inheritdoc />
    public partial class ClientNoteTenantNoAction : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientNotes_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_TenantId_StaffMemberId_StartTime",
                table: "Appointments",
                columns: new[] { "TenantId", "StaffMemberId", "StartTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingHours_StaffMemberId",
                table: "WorkingHours",
                column: "StaffMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkingHours_TenantId_StaffMemberId_DayOfWeek",
                table: "WorkingHours",
